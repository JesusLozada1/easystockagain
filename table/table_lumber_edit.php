...
<?php
        require_once 'lumber_process.php'; ?>
...
<form action="lumber_process.php" method="POST">
<input type = "hidden" name="id" value="<?php echo $id; ?>">
    <div class="form-group">
    <label>Name</label>
    <input type="text" name="lname" class="form-control" 
    value="<?php echo $laname; ?>" placeholder="Enter lumber name">
    </div>

    <div class="form-group">
    <label>Brand</label>
    <input type="text" name="lsize" class="form-control"
    value="<?php echo $lasize; ?>" placeholder="Enter lumber size">
    </div>

    <div class="form-group">
    <label>Color</label>
    <input type="text" name="lcolor" class="form-control"
    value="<?php echo $lacolor; ?>" placeholder="Enter lumber color">
    </div>    
