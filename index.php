                ...
                <form class="form-pop my-2" method="POST">
                    <div>
                        <div class="form-group">
                            ...
                            <input id="user" class="input form-control rounded-0" type="text" name="Username" placeholder="Enter username" required/>
                        </div>
                        <div class="form-group">
                            ...
                            <input class="input form-control rounded-0" type="password" name="Password" placeholder="Password" required/>
                        </div>
